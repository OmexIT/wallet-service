...
public class AppError {
  ...
  private static final class ErrorBlock {
    ...
    public ErrorBlock(
      ...
      this.errors =
          List.of(new Error(domain, reason, errorMessage, errorReportUri + "?id=" + uniqueId));
    }
  ...
  private static final class Error {
    ...
    public Error(
        final String domain, final String reason, final String message, final String sendReport) {
      this.domain = domain;
      this.reason = reason;
      this.message = message;
